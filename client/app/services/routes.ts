...
export interface RewatchRoute<P = {}, C extends Context = Context, R = any> extends UniversalRouterRoute<C, R> {
...
interface RouteItem extends RewatchRoute<any> {
  id: string | null;
}
...
class Routes {
  ...
  public register<P>(id: string, route: RewatchRoute<P>) {
