/**
 * Asserts the preview chart canvas exists (ECharts renders to canvas).
 * @param should Passed to should expression after chart element is captured
 */
export function assertPlotPreview(should = "exist") {
  cy.getByTestId("VisualizationPreview")
    .find(".chart-visualization-container canvas")
    .should(should);
}
