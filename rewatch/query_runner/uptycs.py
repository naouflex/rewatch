...
class Uptycs(BaseSQLQueryRunner):
    ...
    def transformed_to_rewatch_json(self, data):
        transformed_columns = []
        rows = []
    ...
    def api_call(self, sql):
        ...
        if response.status_code == 200:
            ...
            data = {}
            return data, error
        # if we get right status code then call transfored_to_rewatch
        data = self.transformed_to_rewatch_json(response_output)
        error = None
    ...
    def get_schema(self, get_stats=False):
        ...
        for each_def in schema["tables"]:
            ...
            rewatch_json.append(table_json)
