...
_TAG_TABLE: List[Tuple[str, str, str]] = [
    ...
    ("/api/query_snippets", "QuerySnippets", "Reusable SQL snippets shared across queries."),
    ...
    ("/api/destinations", "Destinations", "Alert notification destinations (Slack, email, webhooks, ...)."),
